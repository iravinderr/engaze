...
const UserProfile = () => {
  ...
  return (
    <div className="user-profile-container flex flex-col items-center">
      ...
      <div className="user-details-container flex-col items-center md:flex-row  w-[80vw] p-[2rem] shadow-md rounded-lg mb-[2rem]">
      ...
      <div className="profile-image-container">
        ...
        <div className="user-info flex flex-col gap-2 items-center md:items-start pt-[2rem] md:pt-0">
